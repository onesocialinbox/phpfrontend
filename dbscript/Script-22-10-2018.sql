...
--
-- Host: localhost
-- Generation Time: Oct 22, 2018 at 06:43 PM
...
('Applicant', 4, 1540059060),
('AppAdmin', 2, 1540053736);
...
INSERT INTO `employmentform` (`id`, `user_id`, `companyname`, `lastworkingDate`, `city`, `natureofEmployment`, `yearsOfService`) VALUES
(1, NULL, 'dd', '0000-00-00', 'd', 'd', 3),
(124, 1, 'Naethra', '2017-05-31', 'chennai', 'Software', 1);
...
INSERT INTO `enrollment_master` (`Id`, `user_id`, `Name`, `FatherName`, `DateOfBirth`, `Phone`, `Email`, `ApplicationFormId`, `chgd_dt`, `chgd_by`) VALUES
(1, NULL, 'Test', 'test', '1989-01-01', '1234567890', 'test@yopmail.com', '1234rtetsre', '2018-10-12 14:44:31', NULL),
(2, NULL, 'Test1', 'Test1', '1987-01-01', '1234567890', 'test1@yopmail.com', 'T001', '2018-10-14 22:18:33', NULL),
(3, 1, 'Justy shyjin Justin', 'Justin', '1987-09-20', '9487645878', 'justyshyjin@gmail.com', '2143', '2018-10-22 23:53:07', NULL);
...
(3, 'admin', '3xYw78IeTXqjA-3n2ZutngWeI7L2IroV', '$2y$13$fDm.bA0Zt2LlvqskfA5enOeMggxqc4fSzLSsUGXiuD0hmnIlFboGO', NULL, 1, 0, 1539533955, 1540057386, '::1', '', '', 0),
...
INSERT INTO `userbasicdetailsmaster` (`ID`, `user_id`, `AIBE`, `AlternatePhoneNumber`, `community`, `bloodGroup`, `barAssociation`, `gender`, `casePending`, `convictionDetails`, `remarks`, `toBeMovedBy`, `uniqueGovtID`, `uniqueGovtId_type_cd`) VALUES
(1, NULL, 1, '434234', 'ws', 'o+ive', 'test', 'male', 1, 'test', 'test', 'fes', '12321', '321312'),
(3, 1, 1, '21413412', 'sf', 'ts', 'wer', 'fasd', 123, 'fas', 'sfa', 'dsf', '234', 'sf'),
(5, NULL, 12, '21413412', 'sf', 'ts', 'wer', 'fasd', 23, 'fas', 'sfa', 'dsf', '234', 'sf');
...
INSERT INTO `userotherinformation` (`ID`, `user_id`, `isQualifiedSec24`, `previouslyApplied`, `rejectReason`, `newspaperPublicationDate`, `newspaperPublished`) VALUES
(1, NULL, 1, 1, 'test', '0000-00-00', 'test'),
(12, 1, 1, 1, '2', '2018-09-20', '1');
...
(1, 1, 1, 12321, 1, 213, 1, 123, 1, 23, 6, 32, 6, 4, 5, 4, 5, 1, 4, 1, 4, 1, 2, 2),
(3, NULL, 1, 12321, 1, 213, 1, 123, 1, 123, 1, 123, 1, 123, 1, 123, 1, 123, 1, 123, 1, 213, 1, 213),
(4, 1, 8, 5, 9, 6, 5, 6, 1, 7, 3, 8, 3, 123, 8, 5, 6, 6, 4, 8, 3, 0, 1, 2);
...
INSERT INTO `USER_LAW_ADDRESS_MASTER` (`ID`, `user_id`, `permanentAddress1`, `permanentAddress2`, `permanentAddress3`, `permanentAddress4`, `permanentCity`, `permanentState`, `permanentDistrict`, `permanentPincode`, `communicationAddress1`, `communicationAddress2`, `communicationAddress3`, `communicationAddress4`, `communicationCity`, `communicationState`, `communicationDistrict`, `communicationPincode`) VALUES
(7, 1, 'america', 'america', 'america', 'australia', 'Chennai', 'TamilNadu', 'torrento', '600040', 'europe', 'switcherland', 'canada', 'malaysia', 'los angels', 'otava', 'china', '123145');
...
INSERT INTO `USER_SCHOOL_MASTER` (`id`, `user_id`, `sslcYear`, `sslcSchool`, `sslcMarks`, `sslcBoard`, `hscYear`, `hscSchool`, `hscMarks`, `hscBoard`) VALUES
(1, NULL, '2004-07-05', 'test', 233, 'test', '2006-07-05', 'test', 255, 'tset'),
(2, NULL, '2018-12-12', 'test', 455, 'tn', '2018-12-12', 'three', 255, 'tn'),
(3, NULL, '2018-12-12', 'lms', 455, 'tn', '2018-12-12', 'lms', 459, 'tn'),
(4, NULL, '2018-12-12', 'lms', 455, 'tn', '2018-12-12', 'lms', 459, 'tn'),
(5, NULL, '2018-12-12', 'lms', 455, 'tn', '2018-12-12', 'lms', 459, 'tn'),
(6, NULL, '2018-12-12', 'lms', 455, 'tn', '2018-12-12', 'lms', 459, 'tn'),
(7, NULL, '2018-12-12', 'lms', 455, 'tn', '2018-12-12', 'lms', 459, 'tn'),
(8, NULL, '2018-12-12', 'lms', 455, 'tn', '2018-12-12', 'lms', 459, 'tn'),
(9, NULL, '2018-12-12', 'lms', 455, 'tn', '2018-12-12', 'lms', 466, 'tn'),
(10, NULL, '2018-12-12', 'lms', 455, 'tn', '2018-12-12', 'lms', 466, 'tn'),
(11, NULL, '2018-12-12', 'lms', 455, 'tn', '2018-12-12', 'lms', 466, 'tn'),
(12, NULL, '2018-12-12', 'lms', 455, 'tn', '2018-12-12', 'lms', 466, 'tn'),
(13, NULL, '2018-12-12', 'lms', 455, 'tn', '2018-12-12', 'lms', 466, 'tn'),
(14, 1, '2018-12-12', 'apjm', 455, 'tn', '2018-12-12', 'apjm', 466, 'four');
...
INSERT INTO `USER_STATUS_MASTER` (`ID`, `user_id`, `enrollmentStatus_cd`, `applicationStatus_cd`, `vmsStatus_cd`, `documentVerificationStatus_cd`, `directCallStatus_cd`, `bgVerificationStatus_cd`, `idCreationStatus_cd`, `paymentStatus_cd`, `secretaryCallStatus_cd`) VALUES
(1, NULL, 100, 100, 123, 234, 453, 564, 645, 345, 342),
...
(48, '5bc767405d764', '::1', 'en', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_13_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36', 4, 1539794752, 'Chrome', 'mac'),
(49, '5bc820ab94918', '::1', 'en', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_13_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36', 1, 1539842219, 'Chrome', 'mac'),
(50, '5bc821522abe8', '::1', 'en', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_13_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36', 1, 1539842386, 'Chrome', 'mac'),
(51, '5bcabf2b7192c', '::1', 'en', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_13_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36', 1, 1540013867, 'Chrome', 'mac'),
(52, '5bcb211d9e80e', '::1', 'en', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36', 1, 1540038941, 'Chrome', 'mac'),
(53, '5bcb6fd27702e', '::1', 'en', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36', 4, 1540059090, 'Chrome', 'mac'),
(54, '5bcb814775c8e', '::1', 'en', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36', 1, 1540063559, 'Chrome', 'mac'),
(55, '5bcb824cb32de', '::1', 'en', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36', 4, 1540063820, 'Chrome', 'mac'),
(56, '5bccbf574aa5c', '::1', 'en', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36', 1, 1540144983, 'Chrome', 'mac'),
(57, '5bcde521f361c', '::1', 'en', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36', 4, 1540220194, 'Chrome', 'mac'),
(58, '5bcde560e096c', '::1', 'en', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36', 1, 1540220256, 'Chrome', 'mac');
...
--
-- Indexes for table `userotherinformation`
--
ALTER TABLE `userotherinformation`
  ADD PRIMARY KEY (`ID`);
...
--
-- AUTO_INCREMENT for table `userbasicdetailsmaster`
--
ALTER TABLE `userbasicdetailsmaster`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `userotherinformation`
--
ALTER TABLE `userotherinformation`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `USER_CHECKLIST_MASTER`
--
ALTER TABLE `USER_CHECKLIST_MASTER`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `USER_LAW_ADDRESS_MASTER`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT COMMENT 'user unique id', AUTO_INCREMENT=8;
...
--
ALTER TABLE `USER_SCHOOL_MASTER`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'user unique id', AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `USER_STATUS_MASTER`
--
ALTER TABLE `USER_STATUS_MASTER`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT COMMENT 'user unique id', AUTO_INCREMENT=3;
